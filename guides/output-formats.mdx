...
```markdown
| id | title | author | state | targetBranch |
| --- | --- | --- | --- | --- |
| 42 | feat: add retry logic | jane.smith | OPEN | release/2026-04-17 |
| 41 | fix: null pointer in handler | bob.jones | OPEN | release/2026-04-17 |
```
...
cops bamboo deploy env results --envId 1001 --output json
```
